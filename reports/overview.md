...
_Figure 1 — Fragmented metadata ecosystem before Egeria_
...
_Figure 2 — Egeria concept: one connector per tool as the translation bridge_
...
| Stakeholder                    | Role                                                                                                                      |
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------- |
| **Asset Consumer**             | Use the metadata catalog to discover datasets, understand lineage, and assess quality before building pipelines or models |
| **Data stewards**              | Define and maintain business glossaries, data policies, and compliance controls ensuring responsible data use             |
...
| **Information Architect**      | Design organization-wide data governance strategies, leveraging Egeria as a unified metadata layer                        |
...
| **Platform Administrator**     | Take responsibility for deploying, configuring and operating Egeria.                                                      |
...
_Figure 4 — Bidirectional metadata exchange through Egeria connectors_
...
_Figure 5 — Distributed operation: multiple OMAG platforms in a federated cohort_
