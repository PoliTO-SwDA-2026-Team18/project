...
See: `../../../diagrams/patterns/pattern-adapter.puml`

---

### UML Diagram Structure (example, update your .puml to match the actual code):
...
> **Note:** Update with the actual generated UML diagram (.png) and add extra relevant Adapter examples as appropriate.
